...
window.addEventListener("load", function() {
    ...
    document.querySelector("form").addEventListener("submit", function(event) {
        ...
        let coilotName = (document.querySelector("input[name=copilotName]").value);
        let fuelLevel = (document.querySelector("input[name=fuelLevel]").value);
        let cargoMass = (document.querySelector("input[cargoMass]").value);
...
function formSubmission(document, list, pilot, copilot, fuelLevel, cargoLevel) {
    // pull in all of the inputs from the html fields.
    // let pilotName = document.getElementsByName("pilotName");
    // let copilotName = document.getElementsByName("fuelLevel");
    // let fuelLevel = document.getElementsByName("fuelLevel");
    // let cargoMass = document.getElementsByName("cargoMass");

    // let pushPilotName = document.getElementsByName("pilotStatus");
    // let pushCopilotName = document.getElementsByName("copilotStatus");
